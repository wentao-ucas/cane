...
pv = pd.read_csv('data/corn_monthly_pivot.csv', index_col=0)
...
cbar.set_label('月涨跌幅 %')
ax.set_title('大商所玉米 C0 月度涨跌幅 (2005-01 ~ 2026-05)', fontsize=14, pad=12)
ax.set_xlabel('月份')
ax.set_ylabel('年份')

Path('output').mkdir(exist_ok=True)
out = 'output/corn_monthly_heatmap.png'
plt.tight_layout()
